...
const mutelog = message.guild.channels.cache.find(c => c.id === '793437938318573588')//Mute logu
const muterol = message.guild.roles.cache.find(r => r.id === '793437570222391326')//Muteli rolü
